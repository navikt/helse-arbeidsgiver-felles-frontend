...
describe('loginExpiryAPI', () => {
  ...
  it('should ParseExpiryDate with no timezone', async () => {
    expect(ParseExpiryDate('2020-01-23T08:27:57.125+0000')).toEqual(new Date(2020,0,23, 9, 27, 57, 125));
  })

  it('should ParseExpiryDate with timezone +2 hours', async () => {
    expect(ParseExpiryDate('2020-01-23T08:27:57.125+0200')).toEqual(new Date(2020,0,23, 7, 27, 57, 125));
  })
